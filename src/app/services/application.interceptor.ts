  ...
  constructor(private injector: Injector) {}
   ...
   intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    if(request.url===this.domain+"application/newApplication"){
      ...
      }else if(request.url===this.domain+"application/getApplicationModerators/"+this.applicationService.route+this.localizeService.parser.currentLang){
        request = request.clone({
          setHeaders: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+this.authService.authToken, // Attach token
      ...
      }else if(request.url===this.domain+"application/getApplicationContributors/"+this.applicationService.route+this.localizeService.parser.currentLang){
        request = request.clone({
          setHeaders: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+this.authService.authToken, // Attach token
