...
export class EventService {
  ...
  public getUserEvents(userId,filters,language) {
    var data = {'userId': userId,'filters': filters, 'language': language };
    return this.http.post<any>(this.domain + 'event/userEvents',data);
  }
